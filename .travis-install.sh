...
if [ -d vendor/bin ]
then
  printf "\e[0;34;40m using cache. nothing to do";
else
  printf "\e[0;34;40m getting latest PHPUnit";
  wget https://phar.phpunit.de/phpunit.phar -O yurii/phpunit.phar --no-check-certificate
  printf "\e[0;34;40m removing dev deps as we have ones in CI or not required for testing";
  ...
  printf "\e[0;34;40m downloading dependencies...";
