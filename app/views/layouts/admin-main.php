...
\app\assets\Bootstrap::register($this);
\app\assets\FontAwesomeIcons::register($this);
\app\assets\AdminLTE::register($this);
?>
<?php $this->beginPage(); ?>
<!DOCTYPE html>
										...
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<!-- User Image -->
													<img
														src="<?php echo Yii::getAlias('@web/assets/admin-lte/img/user2-160x160.jpg');?>"
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="<?php echo Yii::getAlias('@web/assets/admin-lte/img/user2-160x160.jpg');?>" class="img-circle" alt="User Image" />
					</div>
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="<?php echo Url::to(['site/index'])?>"><i class='fa fa-link'></i><span>Books</span></a></li>
					<li><a href="#"><i class='fa fa-link'></i> <span>Another Link</span></a></li>
					<li class="treeview"><a href="#"><i class='fa fa-link'></i> <span>Multilevel</span>
