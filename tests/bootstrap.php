...
//
// Carbon copy from Laravel framework
// https://github.com/laravel/framework/tree/13.x/src/Illuminate/Testing/Constraints
//
$autoload->addClassMap([
    ...
    \Illuminate\Foundation\Testing\Concerns\InteractsWithDatabase::class => __DIR__ . '/Constraints/InteractsWithDatabase.php',
